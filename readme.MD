...
`sudo rm -rf /usr/local/sbin/letencrypt; rm -f /usr/local/sbin/letencrypt*; rm -rf /root/letsencrypt /root/installssl.pl; rm -f /etc/letsencrypt/live/bundle.txt && echo "Uninstall Complete"`
